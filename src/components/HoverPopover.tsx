...
const HoverPopover = ({ openHook, debit, onRemoveDebit }) => {
  ...
  const handleMouseOver = () => {
    ...
    if (debit.length) setShowDialog(true);
  };
  ...
  return (
    <div>
      ...
      >
        <span>
          <span style={{ color: '#fff' }}>Income: </span>
        ...
        {debit.map((num, index) => (
          <>
            ...
            >
              ...
              <IconButton onClick={() => onRemoveDebit(num)}>
                <DeleteForeverIcon fontSize="small" htmlColor="Crimson" />
              </IconButton>
            </Typography>
            <Typography variant="body2" sx={{ display: 'flex', justifyContent: 'space-around' }}>
