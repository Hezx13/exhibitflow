  ...
  return (
    <GridToolbarContainer>
      <AddNewItem
        ...
        onAdd={(text, article, price, quantity, unit, comment, deliveryDate) => {
      ...
      {isSaved && (
        <Alert sx={{ padding: '0px 15px' }} variant="outlined" severity="success">
          Success
        </Alert>
      )}
      {isOccupied ? (
        <Alert severity="warning">Another person is working in this project</Alert>
      ) : null}
    </GridToolbarContainer>
  );
}
